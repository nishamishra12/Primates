...
public class Mangabey extends Monkey {
  ...
  /**
   * Constructs an object of Mangabey species class with different parameters of the monkey.
   *
   ...
   */
  public Mangabey(String name, String size, String sex, int age, double weight,
