...
/**
 * Class for Tamarin Species extends Monkey class.
 */
public class Tamarin extends Monkey {

  /**
   * Constructs an object of Tamarin species class with different parameters of the monkey.
   *
   ...
   */
  public Tamarin(String name, String size, String sex, int age, double weight, String favFood,
