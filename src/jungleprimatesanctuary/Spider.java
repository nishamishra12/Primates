...
public class Spider extends Monkey {
  ...
  /**
   * Constructs an object of Spider species class with different parameters of the monkey.
   *
   ...
   */
  public Spider(String name, String size, String sex, int age, double weight, String favFood,
