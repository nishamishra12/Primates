...
/**
 * Factory class to check the species provided by the user
 * and return the object of the given species.
 */
public class MonkeyFactory {
   ...
   * @throws IllegalArgumentException when the species type entered doesn't match the given species.
   */
  public static Primate createMonkey(String name, String size, String sex, int age, double weight,
    ...
    switch (speciesType) {
      ...
      default:
        throw new IllegalStateException("Unexpected value of the species: " + speciesType);
    }
  }
}
